...
public class Result {
    ...
    public Result setOut(List<Message> out) {
        this.out = out;
        return this;
    }

    Result(Value[][] tableau, Value[] soluzione, Value[] costiRidotti, Value z, Value[][] a, List<Integer> basis, List<Value> valoreVariabili) {
    ...
    public static Result fromTableau(Value[][] tableau, boolean invert) {
        ...
        return new Result(tableau, soluzione, costiRidotti, z, a, null, valoreVariabili);
    }

    public static Result fromTableau(Value[][] tableau) {
    ...
    public static void main(String[] args) {
        Result f = Result.fromTableau(new Fraction[][] { { Value.ONE, Value.ZERO, Value.ZERO } });
