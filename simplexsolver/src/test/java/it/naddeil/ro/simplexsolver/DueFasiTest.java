...
public class DueFasiTest {
    ...
    void testGetIdentity() {
        ...
        Value[][] expected = new Value[][] { { Value.ONE, Value.ZERO, Value.ZERO }, { Value.ZERO, Value.ONE, Value.ZERO },
    ...
    void testAggiuntaVariabiliSintetiche() {
        Fraction[][] tableau = new Fraction[][] { { Value.ONE, Value.ONE, Value.ONE, Value.ZERO }, { Value.ONE, Value.ONE, Value.ONE, Value.ZERO },
                { Value.ONE, Value.ONE, Value.ONE, Value.ZERO } };
        Value[][] nuovoTableau = DueFasi.aggiungiVariabiliSintetiche(tableau).tableau();
        Value[][] tableauExp = new Value[][] { { Value.ZERO, Value.ZERO, Value.ZERO, Value.ONE, Value.ONE, Value.ZERO },
    ...
    void testAggiuntaVariabiliSintetiche2() {
        Fraction[][] tableau = new Fraction[][] { { Value.ONE, Value.ONE, Value.ONE, Value.ZERO }, { Value.ZERO, Value.ONE, Value.ONE, Value.ZERO },
                { Value.ONE, Value.ONE, Value.ONE, Value.ZERO } };
        Value[][] nuovoTableau = DueFasi.aggiungiVariabiliSintetiche(tableau).tableau();
        Value[][] tableauExp = new Value[][] { { Value.ZERO, Value.ZERO, Value.ZERO, Value.ONE, Value.ZERO },
                { Value.ZERO, Value.ONE, Value.ONE, Value.ONE, Value.ZERO }, { Value.ONE, Value.ONE, Value.ONE, Value.ZERO, Value.ZERO } };
    ...
    void testApplicaMetodoDueFasi() {
        Value[][] tableau = new Value[][] { { Value.ONE, Value.ZERO, Value.ZERO, Value.ZERO, Value.ZERO },
        ...
        Value[][] expected = new Value[][] { { Value.ONE, Value.ZERO, Value.ZERO, Value.ZERO, Value.ZERO },
    ...
    void testApplicaMetodoDueFasi2() {
        Fraction[][] tableau = new Fraction[][] { { Value.ONE, Value.ZERO, Value.ONE, Value.ZERO, Value.ZERO },

                { Value.ONE, new Fraction(2), Value.ZERO, Value.ONE, new Fraction(5) }, { Value.ZERO, Value.ONE, Fraction.of(2), Value.ZERO, new Fraction(6) },

        };

        Value[][] out = DueFasi.applicaMetodoDueFasi(tableau, Collections.emptyList());

        Value[][] tableauExp = new Value[][] { { Fraction.of(5, 4), Value.ZERO, Value.ZERO, Fraction.of(1, 4), Fraction.of(-7, 4) },
    ...
    void testApplicaMetodoDueFasiDegenere() {
        // Fase 1 degenere
        Fraction[][] tableau = new Fraction[][] { { Fraction.of(-3), Fraction.of(-2), Fraction.of(-1), Value.ZERO, Value.ZERO, Value.ZERO },
        ...
        Value[][] tableauExp = new Value[][] { { Value.ONE, Value.ZERO, Value.ONE, Fraction.of(2), Value.ZERO, Fraction.of(4) },
                { Fraction.of(2), Value.ONE, Value.ONE, Value.ONE, Value.ZERO, Fraction.of(2) },
    ...
    void dueFasiVincoloRidondante() {
        Value[][] tableau = new Fraction[][] { { Fraction.of(-5), Fraction.of(-4), Fraction.of(-1), Fraction.of(-1), Value.ZERO },
        ...
        Value[][] tableauExpected = new Value[][] { { Value.ZERO, Value.ZERO, Fraction.of(2, 5), Fraction.of(1, 5), Fraction.of(26) },
    ...
    void testProblemaIllimitato() {
        Fraction[][] tableau = new Fraction[][] { { Fraction.of(-4), Value.MINUS_ONE, Value.ZERO, Value.ZERO, Value.ZERO },
                { Value.MINUS_ONE, Value.ONE, Value.ONE, Value.ZERO }, { Fraction.of(3), Fraction.of(-4), Value.ZERO, Value.ONE, Value.ZERO } };
        try {
            Value[][] out = DueFasi.applicaMetodoDueFasi(tableau, Collections.emptyList());
    ...
    // Test vincolo ridondante
    @Test
    void testVincoloRIdondante() {
        Fraction[][] tableau = new Fraction[][] {
                // Fobb
                { new Fraction(-5), new Fraction(-4), Value.MINUS_ONE, Value.MINUS_ONE, Value.ZERO },
                // Vincolo 1
                { Value.ONE, Fraction.of(2), Value.ONE, Value.ZERO, Fraction.of(10) },
                // VIncolo 2
                { new Fraction(5), new Fraction(5), Fraction.of(2), Value.ONE, Fraction.of(30) },
                // Vincolo 3
                { new Fraction(3), new Fraction(1), Value.ZERO, Value.ONE, Fraction.of(10) } };

        Value[][] out = DueFasi.applicaMetodoDueFasi(tableau, List.of());
